document.addEventListener("DOMContentLoaded", async function () {
  ...
  const response = await fetch(`https://marketplacenft.azurewebsites.net/api/Artist/${artistIdParam}`, {
  ...
  for (let i = 0; i < numberOfItems; i++) {
    ...
    artistImagePlaceholder.src = `https://marketplacenft.azurewebsites.net${artistImage}`;
          ...
          <a href="nftpage.html?id=${allId}&artist=${allArtistId}" class="more_card" onclick="passNftId(${allId})">
            ...
            <div class="marketplace_card_placeholder">
              ...
              <div data-atropos-offset="5" class="more_card_artistcard">
                <img class="img-artist-cardrow" src="https://marketplacenft.azurewebsites.net${allArtistsImages}" alt="${allArtistsName}" />
