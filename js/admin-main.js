...
async function showUsers() {
    ...
    try {
        const response = await fetch('https://marketplacenft.azurewebsites.net/api/Users');
...
async function showNFTs() {
    ...
    try {
        const response = await fetch('https://marketplacenft.azurewebsites.net/api/NFT');
        ...
        nftsData.forEach(nft => {
            ...
            row.innerHTML = `<td>${nft.id}</td>
                            ...
                            <td>${nft.imageUrl}</td>
                            <td><img src="https://marketplacenft.azurewebsites.net${nft.imageUrl}" alt="${nft.name}" style="max-width: 100px; max-height: 100px;"></td>
                            <td>${nft.artistId}</td>
...
async function showArtists() {
    ...
    try {
        const response = await fetch('https://marketplacenft.azurewebsites.net/api/Artist');
        const usersData = await response.json();
        ...
        usersData.forEach(artist => {
            ...
            row.innerHTML = `<td>${artist.id}</td>
                            ...
                            <td><img src="https://marketplacenft.azurewebsites.net${artist.imageUrl}" alt="${artist.name}" style="max-width: 100px; max-height: 100px;"></td>
                            <td class="admin-actions">
...
async function updateNFT() {
    try {
        ...
        const response = await fetch(`https://marketplacenft.azurewebsites.net/api/NFT/${nftData.id}`, {
            method: 'PUT',
            headers: {
...
async function updateArtist() {
    try {
        ...
        const response = await fetch(`https://marketplacenft.azurewebsites.net/api/Artist/${artistData.id}`, {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${getToken()}`,
            },
...
function editNFT(id) {
    fetch(`https://marketplacenft.azurewebsites.net/api/NFT/${id}`)
...
function editArtist(id) {
    fetch(`https://marketplacenft.azurewebsites.net/api/Artist/${id}`)
        .then(response => response.json())
        .then(artistData => {
            currentArtistId = id;
...
async function deleteArtist(id) {
    try {
        const response = await fetch(`https://marketplacenft.azurewebsites.net/api/Artist/${id}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${getToken()}`,
            },
...
async function deleteNFT(id) {
    try {
        const response = await fetch(`https://marketplacenft.azurewebsites.net/api/NFT/${id}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${getToken()}`,
            },
